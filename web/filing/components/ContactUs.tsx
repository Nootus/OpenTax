      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="https://github.com/nootus/OpenTax/issues" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">
                  Report Issues
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="https://indiatax.ai" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">
                  IndiaTax.AI
                </a>
              </li>
              <li>
                <a href="https://nootus.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">
                  Nootus
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-600 pt-8 mt-8">
          <p className="text-center text-gray-400 text-sm">
            ...
            <a href="https://indiatax.ai" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
              IndiaTax.AI
            </a>
